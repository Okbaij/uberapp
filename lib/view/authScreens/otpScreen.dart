...
class OTFScreen extends StatefulWidget {
  const OTFScreen({super.key});

  @override
  State<OTFScreen> createState() => _OTFScreenState();
}

class _OTFScreenState extends State<OTFScreen> {
    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            Text(
              'Size gönderilen 4 haneli kodu giriniz.',
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: greyShade3),
                  child: Text(
                    'kod almadım (0.$resendOTPCounter)',
